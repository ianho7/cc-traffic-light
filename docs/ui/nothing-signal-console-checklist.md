...
- [ ] 不改变托盘逻辑
- [ ] 不改变任务栏挂载逻辑
- [ ] 不改变 Rust 端业务模型，除非只是适配已有 UI 字段显示
- [ ] 所有原有交互继续可用
- [ ] 页面切换继续可用
- [ ] 设置开关继续可用
- [ ] 监听开关继续可用
...
- [ ] 左侧导航接近 HTML demo 的编号导航风格
- [ ] 主背景接近暖白 / 浅米灰
- [ ] 主面板接近近白底 + 浅灰边框
- [ ] 当前选中导航是黑底白字
- [ ] 设置行接近 demo 的 InfoRow / ToggleRow
- [ ] 状态点和状态标签统一
- [ ] 诊断页接近 demo 的只读信号记录样式
- [ ] 关于页接近 demo 的设备铭牌样式
- [ ] 没有照搬 HTML demo 的 JS 交互
- [ ] 没有新增 HTML demo 中演示用但当前项目没有的功能
- [ ] 没有为了还原 demo 而改 Rust 业务逻辑
